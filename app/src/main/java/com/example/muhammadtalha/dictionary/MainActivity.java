...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        changeLanguage = findViewById(R.id.btn_1);
    ...
    private String findDefintion(String theword) {
        try {
            InputStream input = getAssets().open("tudienanhviet.txt");
        ...
        /*private void formMap(){
         if(flag == 0){
            try {
                ...
                InputStream inputStream = getAssets().open("tudienanhviet.txt");
